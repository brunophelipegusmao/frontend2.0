  ...
  return (
    <section id="events" className="space-y-6 sm:space-y-8">
      ...
      <div className="mx-auto w-full max-w-6xl">
        <div className="grid gap-6 sm:gap-8 lg:grid-cols-[1.35fr_0.65fr] lg:items-stretch">
          <article className="flex h-full flex-col justify-between gap-4 rounded-[24px] border border-[color:var(--border-dim)] bg-[color:var(--card)] p-4 shadow-[0_10px_30px_var(--shadow)] sm:rounded-[28px] sm:p-5">
            <div className="relative h-44 w-full overflow-hidden rounded-2xl border border-white/10 sm:h-48">
              <Image
            ...
            <div className="space-y-2">
              <p className="text-[0.62rem] uppercase tracking-[0.18rem] text-[var(--gold-tone)] sm:text-xs sm:tracking-[0.4rem]">
            ...
            <p className="text-[0.62rem] font-semibold tracking-[0.18rem] text-[#f5d98c] sm:text-xs sm:tracking-[0.4rem]">
